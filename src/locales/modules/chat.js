...
export default {
  questionTitle: _('Agent 提问', 'Agent question'),
  questionWaiting: _('等待你回答', 'Waiting for your answer'),
  questionOther: _('输入其他答案', 'Enter another answer'),
  questionNext: _('下一题', 'Next'),
  questionPrevious: _('上一题', 'Previous'),
  questionSubmit: _('提交全部答案', 'Submit answers'),
  questionCancel: _('取消本次提问', 'Cancel this request'),
  questionSubmitting: _('正在提交，请稍候…', 'Submitting, please wait…'),
  questionRequired: _('请选择或填写答案后继续。', 'Select or enter an answer to continue.'),
  questionAnswerFirst: _('请先回答上方问题，或取消本次提问。', 'Answer the question above or cancel the request first.'),
  questionRefresh: _('重新读取提问', 'Reload questions'),
  questionLoadFailed: _('读取待答问题失败，请重新读取。', 'Pending questions could not be loaded. Please retry.'),
  questionSubmitFailed: _('提交未确认，请检查连接后重试；已填写内容保留。', 'Submission was not confirmed. Check the connection and retry; your input is retained.'),
  questionDisconnected: _('连接已断开，恢复连接后可继续回答。', 'Disconnected. Reconnect to continue answering.'),
  questionSecretHint: _('该问题涉及敏感配置，请从仪表盘打开 OpenClaw 原生面板完成；此处不收集密钥。', 'This question involves sensitive configuration. Open the native OpenClaw UI from the dashboard to complete it; keys are not collected here.'),
  questionStatus_answered: _('已回答，等待 Agent 继续', 'Answered; waiting for the agent to continue'),
  questionStatus_cancelled: _('本次提问已取消', 'Question request cancelled'),
  questionStatus_expired: _('问题已过期，请让 Agent 重新提问', 'Question expired. Ask the agent to request it again.'),
  questionStatus_unavailable: _('该问题已结束或已由其他客户端处理', 'This question has ended or was handled by another client'),
